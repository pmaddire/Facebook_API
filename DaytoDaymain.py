...
def DaybyDay(start_date,end_date,account_id,config_path,fieldf):
    ...
    #path = path.replace('"','')
    my_path = path+"insights"+"/"+account_id
...
DaybyDay(start_date,end_date,account_id,config_path,fieldf)
