# -*- coding: utf-8 -*-
"""
Created on Fri Sep  2 12:06:33 2022
...
def actionDaybyDay(start_date,end_date,account_id,config_path,fieldf):
    ...
    #path = path.replace('"','')
    my_path = path+"actiondevices"+"/"+account_id
...
fieldf = feildsAPI()
actionDaybyDay(start_date,end_date,account_id,config_path,fieldf)
