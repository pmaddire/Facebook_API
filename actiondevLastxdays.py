# -*- coding: utf-8 -*-
"""
Created on Fri Sep  2 14:22:25 2022
...
def actionlastdays(account_id, days, config_path,fieldf):
    ...
    my_path = path+accou+"actiondevices"+"/" + account_id  #setting directory in user
    try:
...
fieldf = feildsAPI()
actionlastdays(account_id, days, config_path,fieldf)