# -*- coding: utf-8 -*-
"""
Created on Thu Sep  1 15:46:32 2022
...
# -*- coding: utf-8 -*-
"""
Created on Thu Sep  1 14:21:29 2022
...
def ageDaybyDay(start_date,end_date,account_id,config_path,fieldf):
    ...
    #path = path.replace('"','')
    my_path = path+"age_gender"+"/"+account_id 
...
fieldf = feildsAPI()
ageDaybyDay(start_date,end_date,account_id,config_path,fieldf)
