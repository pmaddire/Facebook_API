# -*- coding: utf-8 -*-
"""
Created on Thu Sep  1 15:42:19 2022
...
def agelastdays(account_id, days, config_path,fieldf):
    ...
    my_path = path+"age_gender"+"/"+ account_id #setting directory in user
    try:
...
fieldf = feildsAPI()
agelastdays(account_id, days, config_path,fieldf)