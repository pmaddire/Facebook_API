# -*- coding: utf-8 -*-
"""
Created on Thu Sep  1 15:59:01 2022
...
def regionlastdays(account_id, days, config_path,fieldf):
    ...
    my_path = path+"region"+"/"+account_id #setting directory in user
    try:
    ...
    end_date = date.today() #setting the last date of query to 
...
fieldf = feildsAPI()
regionlastdays(account_id, days, config_path,fieldf)